...
print(paste("Total trials covered by THINGS:", count(things_coverage)))
...
print(paste("Number of unique label-target-distractor pairs covered by THINGS:", count(things_coverage |> distinct(image_description_target, image_description_distractor, dataset_name))))
